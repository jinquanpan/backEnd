  ...
  <div>
    <el-card>
      ...
      >
        ...
        <el-table-column prop="fileStarter" label="发起人" width="100" />
        <el-table-column label="操作" align="left" width="300">
          <template slot-scope="{row}">
            <el-button type="primary" size="mini" @click="handleCompile(row)">编制</el-button>
...
<script>
import { workbenchListWriting, workbenchWrite, invalidFile } from '@/api/workbench-doc-control'
...
export default {
  ...
  methods: {
    ...
    // 编制
    handleCompile(row) {
      this.$myConfirm(row.fileName + ' 通过编制', (done) => {
