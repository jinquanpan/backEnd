...
import { docAuditManageSaveFile, docAuditManageDetail, docAuditManageUpgrade, fileType, fileStatus } from '@/api/doc-audit-internal'
export default {
  name: 'FileForm',
  components: {
    UploadFile
  ...
  methods: {
    ...
    show(row) {
      ...
      if (row) {
        docAuditManageDetail(row.docAuditInternalId).then(res => {
          this.form = {
