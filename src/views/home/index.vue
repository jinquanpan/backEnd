            ...
            <el-col :span="12">
              <div class="grid-content">
                <ul class="icons-right">
                  <li class="chain">待处理总数</li>
                  <li>
                    <countTo
                      :start-val="0"
                      :end-val="countData.handlingCount"
                      :duration="1000"
                    />
                  </li>
                </ul>
        ...
        <div class="grid-content bg-white">
          <el-row>
            ...
            <el-col :span="12">
              <div class="grid-content">
                <ul class="icons-right">
                  <li class="chain">待编制数</li>
                  <li>
                    <countTo
                      :start-val="0"
                      :end-val="countData.writingCount"
                      :duration="1000"
                    />
                  </li>
                </ul>
        ...
        <div class="grid-content bg-white">
          <el-row>
            ...
            <el-col :span="12">
              <div class="grid-content">
                <ul class="icons-right">
                  <li class="chain">待审批数</li>
                  <li>
                    <countTo
                      :start-val="0"
                      :end-val="countData.reviewingCount"
                      :duration="1000"
                    />
                  </li>
                </ul>
        ...
        <div class="grid-content bg-white">
          <el-row>
            ...
            <el-col :span="12">
              <div class="grid-content">
                <ul class="icons-right">
                  <li class="chain">待批准数</li>
                  <li>
                    <countTo
                      :start-val="0"
                      :end-val="countData.approvingCount"
                      :duration="1000"
                    />
                  </li>
                </ul>
...
import { homeStatistic } from '@/api/home'
export default {
  name: 'Home',
  components: { countTo },
  data() {
